...
class Category(models.Model):
    ...
    title = models.CharField(max_length=155, default="Shoes")
...
class Vendor(models.Model):
    ...
    title = models.CharField(max_length=155, default="Vendor-1")
    image = models.ImageField(upload_to=user_directory_path, default="vendor.jpg")
    cover_image = models.ImageField(upload_to=user_directory_path, default="vendor.jpg")
    # description = models.TextField(null=True, blank=True, default="Description Vendor")
    description = RichTextUploadingField(
        null=True, blank=True, default="Description Vendor"
    )

    address = models.CharField(max_length=155, default="123 Main Street.")
    contact = models.CharField(max_length=155, default="+123 (456) 789")
    chat_resp_time = models.CharField(max_length=155, default=100)
    shipping_on_time = models.CharField(max_length=155, default=100)
    authentic_rating = models.CharField(max_length=155, default=100)
    days_return = models.CharField(max_length=155, default=100)
    warranty_period = models.CharField(max_length=155, default=100)
...
class Product(models.Model):
    ...
    # description = models.TextField(null=True, blank=True, default="Description Product")
    description = RichTextUploadingField(
...
class CartOrderItems(models.Model):
    ...
    def order_img(self):
        return mark_safe(
            '<img src="/media/%s" width="50" height="50" />' % (self.image.url)
        )
